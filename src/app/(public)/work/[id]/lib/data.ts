import { validateProjects } from "./helpers";

const projectsRaw = [
  {
    
    generalInfos: {
      title: "WeeWee Delivery",
      type: "Rebranding Case Study",
      year: 2021,
      slug: "weewee-delivery-rebranding-case-study",
      summary:
        "Rebranding WeeWee Delivery into a tech-driven, mascot-led logistics brand for Algeria, focusing on innovation, trust, sustainability, and a warmer, more distinctive identity.",
      tags: [
        "branding",
        "rebrand",
        "visual identity",
      ...
      teamMembers: [
        {
          ...
          profileUrl: "https://aymenamokrane.design",
        },
        {
          name: "Fouzi Merabet",
          role: "Motion Graphics",
          profileUrl: "https://fouzimerabet.com",
        },
        {
          name: "Sara Boufligha",
          role: "2D Illustrations",
          profileUrl: "https://saraboufligha.art",
        },
      ],
      heroUrl:"https://firebasestorage.googleapis.com/v0/b/portfolio-aymen-amokrane.firebasestorage.app/o/projects%2FCMTaAao0LnZUgWOLtn0E%2Fhero.jpg?alt=media&token=d5fb4273-d083-4719-8e20-61ebd8eb4d14"
    },

    contentBlocksInfos: [
      {
        type: "heading",
        content: "WeeWee Delivery — Rebranding Case Study",
        order: 1,
      ...
      },
      {
        type: "paragraph",
        content:
          "CLIENT: WeeWee Delivery | REGION: Algeria | INDUSTRY: Logistics, Digital Solutions | YEAR: 2023",
        order: 2,
      },
      {
        type: "paragraph",
    ...
    notesBlocksInfos: [
      { type: "heading", content: "Overview", order: 1 },

      { type: "subheading", content: "Client", order: 2 },
      { type: "paragraph", content: "WeeWee", order: 3 },

      { type: "subheading", content: "Section", order: 4 },
      { type: "paragraph", content: "Logistics / Delivery", order: 5 },

      { type: "subheading", content: "Discipline", order: 6 },
      {
        type: "paragraph",
        content: "Branding / Strategy / Visual Identity",
        order: 7,
      },

      { type: "subheading", content: "Tagline", order: 8 },
      {
        type: "paragraph",
        content: "Playful, scalable identity for a next-gen delivery brand.",
        order: 9,
      },

      { type: "subheading", content: "Summary", order: 10 },
      {
        type: "paragraph",
        content:
      ...
      { type: "subheading", content: "Scope", order: 12 },

      { type: "subheading", content: "Services", order: 13 },
      {
        type: "list",
        content: "Brand Strategy; Logo; Mascot; Guidelines; Art Direction",
        order: 14,
      },

      { type: "subheading", content: "Deliverables", order: 15 },
      {
        type: "list",
        content: "Brandbook; Logo suite; Color & type system; Social kit",
        order: 16,
      },

      { type: "subheading", content: "Team", order: 17 },
      {
        type: "list",
        content:
          "Aymen — Creative Direction; Designer — Identity & Systems; Strategist — Brand Strategy",
        order: 18,
      },

      { type: "subheading", content: "Media Links", order: 19 },
      {
        type: "inlineList",
        content: [{ key: "Behance", value: "https://www.behance.net/" }],
        order: 20,
      },

      { type: "heading", content: "Story", order: 21 },
      { type: "subheading", content: "Project Story", order: 22 },
      {
        type: "paragraph",
        content:
          "WeeWee needed a recognizable identity that could scale across packaging, vehicles, and a mobile app. We built a modular system with a custom logotype, mascot, and flexible shape language to keep the brand playful and unmistakable.",
        order: 23,
      },

      { type: "subheading", content: "System Highlights", order: 24 },
      {
        type: "list",
        content:
          "Custom logotype with clear spacing and grid; Mascot with simple geometry for broad use; Color system optimized for contrast and accessibility; Typographic scale aligned to product UI and marketing",
        order: 25,
      },
    ],
  },
